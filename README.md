...
```javascript
isSameNativeClass = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-native-class@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-native-class@umd/bundle.js"></script>
```
